...
<title>LYCEE BILINGUE DE YAOUNDE</title>
    ...
    <link rel="stylesheet" href="../Style/stylebulletins.css">
    <link rel="stylesheet" href="../../siteProject 2.0 - Copie/fontawesome/css/all.css">
...
?>
    <div class="container">
        ...
        <nav class="nav-links">
                ...
                <img src="../Images/logolby.png" alt="" class="logo">
    ...
    <div class="lien">
    <ul>
        <li><a href="../Pages/membre.php">Membre</a>&nbsp;&nbsp;<i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i> </li>
