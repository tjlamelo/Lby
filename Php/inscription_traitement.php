<?php 
    ...
    if(!empty($_POST['nomparent']) 
        ...
        && !empty($_POST['email']) 
        && !empty($_POST['emailconf']))
    {
        // Patch XSS
        $nomparent = htmlspecialchars($_POST['nomparent']);
                    ...
                    if(filter_var($email, FILTER_VALIDATE_EMAIL)){ // Si l'email est de la bonne forme
                        if($password === $password_retype ){ // si les deux mdp saisis sont bon
                            ...
                            */
                            ...
                            $insert = $bdd->prepare('INSERT INTO inscription(nomparent ,pseudo, email, tel, password, ip, token) VALUES(:nomparent,:pseudo, :email, :tel, :password, :ip, :token)');
